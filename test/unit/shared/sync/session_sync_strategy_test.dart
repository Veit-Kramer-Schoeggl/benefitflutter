  ...
  group('SessionSyncStrategy', () {
    ...
    group('resolveConflict', () {
      group('Case 1: Local session active or paused - ALWAYS keep local', () {
        test('keeps local when local is active and remote is completed', () async {
          // Arrange
          final local = Session(
            id: 'session-1',
            userId: 'user-1',
        ...
        test('keeps local when local is paused and remote is completed', () async {
          // Arrange
          final local = Session(
            id: 'session-1',
            userId: 'user-1',
        ...
        test('keeps local when local is active and remote is cancelled', () async {
          // Arrange
          final local = Session(
            id: 'session-1',
            userId: 'user-1',
      ...
      group('Case 3: Remote completed, local not - take remote', () {
        test('takes remote when remote is completed and local is active', () async {
          // Arrange
          final local = Session(
            id: 'session-1',
            userId: 'user-1',
        ...
        test('takes remote when remote is completed and local is cancelled', () async {
          // Arrange
          final local = Session(
            id: 'session-1',
            userId: 'user-1',
